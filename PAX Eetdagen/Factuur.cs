...
namespace PAX_Eetdagen
{
    public partial class Factuur : Form
    {
        ...
        private void Factuur_Load(object sender, EventArgs e)
        {
            ...
            txtBoxBetalen.Text = "0,00";
            txtBoxTerug.Text = "0,00";
            txtBoxTotaal.Text = "0,00";
        }
        ...
        {
            float terug = (float)numBetaald.Value - Convert.ToSingle(txtBoxTotaal.Text);
            if (terug > 0)
            {
                txtBoxTerug.Text = terug.ToString("n2");
                txtBoxBetalen.Text = "0,00";
            }
            else
            {
                txtBoxTerug.Text = "0,00";
                txtBoxBetalen.Text = (terug * -1).ToString("n2");
            }
        }
        ...
        private void CalcTotal()
        {
            ...
            txtBoxTotaal.Text = totaal.ToString("n2");
        ...
        private void txtBoxTotaal_TextChanged_1(object sender, EventArgs e)
        {
            float terug = (float)numBetaald.Value - Convert.ToSingle(txtBoxTotaal.Text);
            if(terug > 0)
            {
